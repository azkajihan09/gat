...
import 'package:windy_sabtami_s_application1/presentation/currency_exchange_screen/models/currency_exchange_model.dart';
part 'currency_exchange_event.dart';
part 'currency_exchange_state.dart';

/// A bloc that manages the state of a CurrencyExchange according to the event that is dispatched to it.
